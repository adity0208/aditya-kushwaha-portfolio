...
const projectsData: Project[] = [
  ...
  {
    title: 'EchoCart: AI-Powered Voice Shopping Assistant',
    description: 'An intelligent, bilingual shopping list app that understands natural voice commands in English and Hindi, built with a sophisticated NLP pipeline.',
    longDescription: 'This project showcases a full-stack approach to building an intelligent voice-first application. It features a robust Python backend with a sophisticated NLP pipeline to interpret natural language commands. The system handles typos with fuzzy matching, normalizes plurals and synonyms, and even provides smart suggestions. The front-end, built with Flask, captures audio directly in the browser and communicates with the backend to provide a seamless, hands-free shopping list experience.',
    imageUrls: [{ src: '/images/Cart.png', hint: 'UI of the voice shopping assistant' }], // IMPORTANT: Remember to add a screenshot of your project here
    tags: ['Python', 'Flask', 'NLP', 'AI', 'Speech Recognition', 'REST API', 'Bilingual'],
    githubLink: 'https://github.com/adity0208/Voice-Command-Shopping-Assistant',
    liveLink: 'https://voice-shopping-assistant-app.onrender.com/',
    isLive: true,
    keyFeatures: [
      'Bilingual voice recognition for commands in English and Hindi.',
      'Advanced NLP pipeline for intent recognition and typo correction.',
      'Smart suggestions for items based on shopping history and seasonality.',
      'Full list management: add, remove, find, and clear items via voice.',
      'Data persistence ensures your shopping list is saved between sessions.',
      'Export functionality to save the list as a CSV or PDF file.',
    ],
  },
  {
