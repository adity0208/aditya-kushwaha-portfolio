...
import { type Project } from '@/components/cards/project-card'; // Keep interface import
...
const projectsData: Project[] = [
  {
    ...
    imageUrls: [{ src: 'https://placehold.co/800x600.png', hint: 'health app dashboard' }],
    ...
    liveLink: 'https://carelinks.example.com', // Placeholder
    isLive: true,
    keyFeatures: [
  ...
  },
  {
    ...
    imageUrls: [{ src: 'https://placehold.co/800x600.png', hint: 'chatbot ui interface' }],
  ...
  },
  {
    ...
    imageUrls: [{ src: 'https://placehold.co/800x600.png', hint: 'reminder app interface' }],
            ...
            <div key={project.title}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                ...
                <div className={`relative w-full aspect-[16/10] rounded-xl overflow-hidden shadow-2xl group ${index % 2 !== 0 && 'lg:order-last'}`}>
                  ...
                  {/* Example of a subtle overlay, if needed for specific images or styles
                ...
                <div className="flex flex-col justify-center py-4">
                  <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-3">
                    <span className="text-accent font-sans mr-2">—</span>{project.title}
                  </h3>
                  ...
                  {project.keyFeatures && project.keyFeatures.length > 0 && (
                    <div className="mb-6">
                      {/* Use a slightly less prominent heading for "Key Features" or integrate into description flow */}
